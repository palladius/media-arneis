...
- [x] **Track: Implement expensive, end-to-end LLM integration tests (just-llm-tests)**
...
- [x] **Track: Implement CharacterImage Generation with Gemini Vision Evaluation**
...
- [x] **Track: Implement Evaluation Feedback Loop for retrying failed generations**
...
- [x] **Track: Clean up testing semantics: separate fast unit tests (<5s) from LLM-as-judge integration tests.**
