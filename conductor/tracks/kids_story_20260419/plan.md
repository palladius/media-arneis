...
- [ ] Task: Define `KidsStoryContract` in `Arneis::Schema`.
- [ ] Task: Create `data/templates/KidsStory.yaml` with default values.
- [ ] Task: Write Tests for `KidsStory` hydration and validation.
